import {ArrowRight, MessageCircle, Heart, Eye, Coffee, Sparkles} from 'lucide-react'
...
const Landing = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-200 to-blue-200 relative overflow-hidden">
            ...
            <div
                className="absolute bottom-20 left-20 w-8 h-8 bg-yellow-400 rounded-full opacity-60 animate-pulse"></div>
            ...
            <section className="py-20 px-4 relative overflow-hidden">
                <div
                    className="absolute inset-0 bg-gradient-to-br from-blue-100/50 to-transparent pointer-events-none"></div>
                <div className="max-w-4xl mx-auto text-center relative z-10">
                    <div className="mb-8">
                        <div
                            className="w-24 h-24 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full mx-auto mb-6 shadow-lg flex items-center justify-center animate-bounce">
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight text-gray-800">
                        Wanna stalk someone?{' '}
                        <span
                            className="bg-gradient-to-r from-blue-500 to-blue-700 bg-clip-text text-transparent drop-shadow-lg">
                            Let's start with Chaos!
                        </span>
                    </h1>
                    <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto leading-relaxed">
                        Have someone in mind you wanna know about? Let's search for them together!
                        It's like social media but actually fun and not soul-crushingly corporate.
                    </p>
            ...
            <section className="py-16 px-4">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold mb-4 text-gray-800">Why Chaos is Actually Fun</h2>
                        <p className="text-gray-700 text-lg">
                            Unlike those other platforms that make you feel bad about yourself...
                        </p>
                    </div>
                            ...
                            return (
                                ...
                                >
                                    <CardContent className="p-6 text-center">
                                        ...
                                        <h3 className="font-semibold mb-2 text-gray-800 text-lg">{feature.title}</h3>
            ...
            <section className="py-16 px-4 bg-white/50 backdrop-blur-sm">
                <div className="max-w-4xl mx-auto">
                    <h3 className="text-2xl font-bold text-center mb-8 text-gray-800">The Chaos Report 📊</h3>
                    <div className="grid md:grid-cols-3 gap-8 text-center">
                        <div className="group cursor-pointer">
                            <div
                                className="text-4xl font-bold text-blue-600 mb-2 group-hover:scale-110 transition-transform">420+
                            </div>
                        ...
                        <div className="group cursor-pointer">
                            <div
                                className="text-4xl font-bold text-blue-600 mb-2 group-hover:scale-110 transition-transform">69K+
                            </div>
                        ...
                        <div className="group cursor-pointer">
                            <div
                                className="text-4xl font-bold text-blue-600 mb-2 group-hover:scale-110 transition-transform">∞
                            </div>
            ...
            <section className="py-16 px-4">
                <div className="max-w-4xl mx-auto">
                    <h3 className="text-2xl font-bold text-center mb-8 text-gray-800">What People Are Saying</h3>
                    <div className="grid md:grid-cols-2 gap-6">
                        <Card className="bg-gradient-to-br from-pink-100 to-blue-100 border-0">
                            <CardContent className="p-6">
                                <p className="text-gray-700 mb-4 italic">"Finally found out what my neighbor's cat is up
                                    to. 10/10 would stalk again."</p>
                                <p className="text-sm text-gray-600">- Anonymous Cat Enthusiast 🐱</p>
                            </CardContent>
                        </Card>
                        <Card className="bg-gradient-to-br from-yellow-100 to-green-100 border-0">
                            <CardContent className="p-6">
                                <p className="text-gray-700 mb-4 italic">"My ex is learning pottery now. Good for them!
                                    This app makes stalking wholesome."</p>
                                <p className="text-sm text-gray-600">- Reformed Ex-Stalker 🏺</p>
                            </CardContent>
                        </Card>
                    </div>
                </div>
            ...
            <section className="py-16 px-4">
                <div className="max-w-4xl mx-auto">
                    <Card
                        className="bg-gradient-to-br from-blue-400 to-blue-600 text-white border-0 shadow-2xl overflow-hidden relative">
                        <div className="absolute inset-0 bg-blue-500/20 backdrop-blur-3xl"></div>
                        <CardContent className="p-12 text-center relative z-10">
                            <div className="text-6xl mb-6 animate-bounce">🎭</div>
                            <h2 className="text-3xl font-bold mb-4">Ready to Join the Beautiful Chaos?</h2>
                            <p className="text-lg mb-6 opacity-90 max-w-2xl mx-auto">
                                Life's too short for boring social media. Come be weird with us!
                                Your friends are probably doing something interesting right now...
                            </p>
                            <Button
                                size="lg"
                                variant="secondary"
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
                        <div className="flex items-center space-x-6">
                            <span className="text-sm text-gray-500">© 2024 Chaos (we're still figuring it out)</span>
                            <Button variant="link"
                                    className="text-sm text-gray-600 hover:text-blue-600 transition-colors">Privacy (we
                                promise we're cool)</Button>
                            <Button variant="link"
                                    className="text-sm text-gray-600 hover:text-blue-600 transition-colors">Terms (but
                                fun)</Button>
                            <Button variant="link"
                                    className="text-sm text-gray-600 hover:text-blue-600 transition-colors">Help (we got
                                you)</Button>
                        </div>
                        <p className="text-xs text-gray-500 flex items-center">
                            Made with <Heart className="w-3 h-3 text-red-500 mx-1 animate-pulse"/> by people who get it
                        </p>
                    </div>
                </div>
            </footer>
