    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-gray-200 to-blue-200">
            ...
            >
                {/* Login Form */}
                <div
                    className="absolute top-0 left-1/2 w-1/2 h-full bg-white flex items-center text-gray-800 text-center p-10 z-20 opacity-100 pointer-events-auto">
                    <div className="w-full">
                        ...
                        <form onSubmit={handleLoginFormSubmit}>
                            <div className="relative my-8">
                                ...
                                />
                                <User
                                    className="absolute right-5 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-600"/>
                            </div>
                ...
                <div className="absolute w-full h-full pointer-events-none">
                    <div
                        className="absolute w-[300%] h-full bg-blue-400 rounded-[150px] z-5 -left-[250%] transition-all duration-[1800ms] ease-in-out"></div>
                </div>

                {/* Welcome Panel - Left */}
                <div
                    className="absolute left-0 w-1/2 h-full text-white flex flex-col justify-center items-center z-15 opacity-100 transition-all duration-[600ms] ease-in-out">
                    <div>
