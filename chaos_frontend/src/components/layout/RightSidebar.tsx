...
const suggestions = [
    {id: 1, name: 'Sarah Chen', username: 'sarahc_dev', avatar: '/placeholder.svg', status: 'Learning pottery 🏺'},
    {id: 2, name: 'Alex Smith', username: 'alexsmith', avatar: '/placeholder.svg', status: 'Cat enthusiast 🐱'},
    {
        id: 3,
        name: 'Maya Patel',
...
const RightSidebar = () => {
    return (
        <aside
            className="fixed right-0 top-16 h-[calc(100vh-4rem)] w-80 bg-gradient-to-b from-gray-50 to-blue-50 border-l border-blue-200 shadow-lg p-4 overflow-y-auto">
                            ...
                            <div key={user.id}
                                ...
                                <div className="flex items-center space-x-3">
                                    <div className="relative">
                                        <Avatar
                                            className="w-10 h-10 ring-2 ring-blue-200 group-hover:ring-blue-400 transition-all">
                            ...
                            <div key={msg.id}
                                ...
                                <div className="relative">
                                    <Avatar className="w-8 h-8">
                                        ...
                                        <AvatarFallback
                                            className="bg-gradient-to-br from-pink-400 to-pink-600 text-white text-xs">
                                            {msg.name.split(' ').map(n => n[0]).join('')}
                                        </AvatarFallback>
                                    </Avatar>
                                    {msg.isOnline && (
                                        <div
                                            className="absolute -bottom-1 -right-1 w-3 h-3 bg-green-400 rounded-full border border-white"></div>
                                    )}
                                </div>
