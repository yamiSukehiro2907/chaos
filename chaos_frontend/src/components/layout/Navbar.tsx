...
const Navbar = () => {
    return (
        <nav
            className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-blue-200 shadow-lg">
            <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                    ...
                    >
                        ...
                        <span
                            className="absolute -top-1 -right-1 w-5 h-5 bg-gradient-to-r from-blue-400 to-blue-600 text-white text-xs rounded-full flex items-center justify-center animate-pulse">
                            3
                        </span>
                    </Button>
                    ...
                    >
                        ...
                        <span
                            className="absolute -top-1 -right-1 w-5 h-5 bg-gradient-to-r from-pink-400 to-red-500 text-white text-xs rounded-full flex items-center justify-center animate-bounce">
                            12
                        </span>
                    </Button>
                    ...
                    >
                        ...
                        <span
                            className="absolute -top-1 -right-1 w-5 h-5 bg-gradient-to-r from-yellow-400 to-orange-500 text-white text-xs rounded-full flex items-center justify-center">
                            5
                        </span>
                    </Button>

                    {/* Profile Avatar */}
                    <Button variant="ghost" className="p-1 rounded-xl hover:bg-blue-100 transition-all duration-300">
                        <Avatar className="w-8 h-8 ring-2 ring-blue-200 hover:ring-blue-400 transition-all">
