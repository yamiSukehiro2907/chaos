          ...
          >
            <div className="relative">
              {story.isOwn ? (
                ...
                <Avatar className="w-16 h-16 ring-2 ring-blue-400 ring-offset-2 ring-offset-white cursor-pointer hover:scale-105 hover:ring-blue-500 transition-all duration-300">
                  <AvatarImage src={story.avatar} alt={story.name} />
